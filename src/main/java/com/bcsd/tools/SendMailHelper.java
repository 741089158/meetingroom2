...
public class SendMailHelper {
    ...
    public static boolean sendMail(String receiveMailAccount, String title, String subject,String content){
    	boolean bool = false;
    	try {
    		String sendEmailAccount = SendMailHelper.getString("sendEmailAccount");
    		String sendEmailPassword = SendMailHelper.getString("sendEmailPassword");
    		String sendEmailSMTPHost = SendMailHelper.getString("sendEmailSMTPHost");
